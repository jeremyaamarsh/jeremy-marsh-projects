...
- SVD can learn meaningful patterns from user ratings and produce reasonable similarity recommendations  
- Cosine similarity on the latent vectors works well for finding related movies  
